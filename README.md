...
Azure administration and security | Identity & access management (RBAC, Entra ID) | Infrastructure as Code (Bicep) | CI/CD (GitHub Actions, OIDC) | PowerShell automation | KQL and observability | Network security | Database security.
